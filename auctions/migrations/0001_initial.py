...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('auctions_project', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('auctions', ['Project'])

        # Adding model 'Auction'
        db.create_table('auctions_auction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auctions.Project'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
    ...
    models = {
        'auctions.auction': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auctions.Project']"}),
        ...
        'auctions.bid': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mode': ('django.db.models.fields.CharField', [], {'default': "'BID'", 'max_length': '3'}),
